...
\begin{document}
	...
	\begin{resume_header}
		...
		\contact {
			 \faHome \, 707 N Hickory Ave. Apt. 3, Bel Air, MD 21014
		}
	\end{resume_header}
...
Interface and dynamic data-binding. Assisted implementation of server and databases on embedded devices.
		...
		\end{resume_employer}
		\fi
		\begin{resume_employer}{Intern}{Summer (2017)}{Thar Energy LLC}
		Assisted in the creation and testing of a test loop for supercritical CO2 heat exchangers. Performed search and selection of
		vendors for various test loop components. Used SolidWorks to create a 3D model of the test loop as well as product
		drawings.
		\end{resume_employer}
	\end{resume_section}
